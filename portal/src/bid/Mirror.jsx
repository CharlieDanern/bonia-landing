...
// The app-mirror — the consumer catalog card, rebuilt per handoff §8.
// Aspect 1.9:1, left-weighted scrim over the rep's art, ghosted card
// artwork on the right when there is no art, bank SMALL+BOLD over the
// product name LARGER+LIGHTER (the app's inverted hierarchy), bare mono
// reward (no label inside the mirror — the 50% explanation belongs to
// the portal chrome around it), perk line, white bottom bar.
//
